...
public class SetupPreflightForm : Form
{
    ...
    private Control BuildHubContent()
    {
        ...
        layout.Controls.Add(lblPub);
        layout.Controls.Add(_tbHubPublicIp);
        ...
        layout.Controls.Add(lblConf);
        layout.Controls.Add(_tbConfDir);
        ...
        _tbTravelNames.Text = string.Join(Environment.NewLine, _ctx.TravelMachineNames);
